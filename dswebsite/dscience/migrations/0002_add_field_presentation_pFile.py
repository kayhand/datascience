...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Presentation.pFile'
        db.add_column(u'dscience_presentation', 'pFile',
                      self.gf('django.db.models.fields.files.FileField')(default=True, max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Presentation.pFile'
        db.delete_column(u'dscience_presentation', 'pFile')
