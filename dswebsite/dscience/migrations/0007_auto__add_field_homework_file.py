...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Homework.file'
        db.add_column(u'dscience_homework', 'file',
                      self.gf('django.db.models.fields.files.FileField')(default=datetime.datetime(2013, 8, 27, 0, 0), max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Homework.file'
        db.delete_column(u'dscience_homework', 'file')
