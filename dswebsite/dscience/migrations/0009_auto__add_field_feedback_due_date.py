...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feedback.due_date'
        db.add_column(u'dscience_feedback', 'due_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 31, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feedback.due_date'
        db.delete_column(u'dscience_feedback', 'due_date')
