...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dscience_assignment', 'due_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Assignment.due_date'
        db.alter_column(u'dscience_assignment', 'due_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'dscience.assignment': {
            ...
            'file_path': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
