...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dscience_feedback', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_giving_feedback', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feedback_giving', to=orm['dscience.UserProfile'])),
            ('user_getting_feedback', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feedback_getting', to=orm['dscience.UserProfile'])),
            ...
            ('exposition', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'dscience', ['Feedback'])


    def backwards(self, orm):
        # Deleting model 'Feedback'
        db.delete_table(u'dscience_feedback')
