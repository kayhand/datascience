...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'dscience_assignment', 'file',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Assignment.aFile'
        raise RuntimeError("Cannot reverse this migration. 'Assignment.aFile' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Assignment.aFile'
        ...
        db.delete_column(u'dscience_assignment', 'file')
