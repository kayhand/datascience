...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feedback.clarity'
        db.add_column(u'dscience_feedback', 'clarity',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Feedback.smoothness'
        db.add_column(u'dscience_feedback', 'smoothness',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Feedback.qa'
        db.add_column(u'dscience_feedback', 'qa',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feedback.clarity'
        db.delete_column(u'dscience_feedback', 'clarity')

        # Deleting field 'Feedback.smoothness'
        db.delete_column(u'dscience_feedback', 'smoothness')

        # Deleting field 'Feedback.qa'
        db.delete_column(u'dscience_feedback', 'qa')
    ...
    models = {
        ...
        u'dscience.feedback': {
            ...
            'clarity': ('django.db.models.fields.IntegerField', [], {}),
            ...
            'qa': ('django.db.models.fields.IntegerField', [], {}),
            'smoothness': ('django.db.models.fields.IntegerField', [], {}),
